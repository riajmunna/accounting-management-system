                        ...
                        var handler = PaystackPop.setup({
                            ...
                            callback: function(response) {
                                ...
                                window.location.href =
                                    '<?php echo e(url('customer/invoice/paystack')); ?>' + '/' +
                        ...
                        var x = getpaidSetup({
                            ...
                            callback: function(response) {
                                ...
                                if (
                                    ...
                                    window.location.href =
                                        '<?php echo e(url('customer/invoice/flaterwave')); ?>' + '/' +
                                        '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)); ?>' +
                                        '/' + txref;
                                } else {
                    ...
                    if (res.flag == 1) {
                        ...
                        var options = {
                            ...
                            "handler": function(response) {
                                window.location.href = '<?php echo e(url('customer/invoice/razorpay')); ?>' +
                                    '/' +
                                    '<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)); ?>' +
                                    '/' + amount;
                                // window.location.href = '<?php echo e(route('customer.invoice.razorpay', ['response.razorpay_payment_id', \Illuminate\Support\Facades\Crypt::encrypt($invoice->id)], 'amount')); ?>' ;
                                ...
                                <?php if($invoice->status != 0): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create payment invoice')): ?>
                                        <a href="#" data-url="<?php echo e(route('invoice.payment', $invoice->id)); ?>"
                                            data-ajax-popup="true" data-title="<?php echo e(__('Add Payment')); ?>" class="btn btn-sm btn-info"
            ...
            <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                <div class="all-button-box mx-2">
                    <a href="#" class="btn btn-xs btn-primary btn-icon-only width-auto"
                        data-url="<?php echo e(route('customer.invoice.send', $invoice->id)); ?>" data-ajax-popup="true"
                        data-title="<?php echo e(__('Send Invoice')); ?>">
                    ...
                    <div class="invoice-print">
                        <div class="row invoice-title mt-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                <h3 class="invoice-number"><?php echo e(AUth::user()->invoiceNumberFormat($invoice->invoice_id)); ?>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <small>
                                    ...
                                    <?php if($invoice->status == 0): ?>
                                        <span
                                            class="badge fix_badge rounded p-1 px-3 bg-primary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                    <?php elseif($invoice->status == 1): ?>
                                        <span
                                            class="badge fix_badge rounded p-1 px-3 bg-info"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                    <?php elseif($invoice->status == 2): ?>
                                        <span
                                            class="badge fix_badge rounded p-1 px-3 bg-secondary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                    <?php elseif($invoice->status == 3): ?>
                                        <span
                                            class="badge fix_badge rounded p-1 px-3 bg-warning"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                    <?php elseif($invoice->status == 4): ?>
                                        <span
                                            class="badge fix_badge rounded p-1 px-3 bg-danger"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                    <?php endif; ?>
                                </small>
                            </div>
                                    ...
                                    <table class="table mb-0 table-striped">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php echo e(\Auth::user()->priceFormat($invoice->getTotalDiscount())); ?></td>
                                            </tr>
                                            ...
                                            <?php if(!empty($taxesData)): ?>
                                                ...
                                                <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="6"></td>
                                                        <td class="text-right"><b><?php echo e($tax->name); ?></b></td>
                                                        <td class="text-right">
                                    ...
                                    <div class="tab-content">
                                        <?php if(
                                            ...
                                            <div class="tab-pane fade active show" id="stripe-payment" role="tabpanel"
                                                ...
                                                <form method="post"
                                                    action="<?php echo e(route('customer.invoice.payment', $invoice->id)); ?>"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-prepend"><span
                                                                        class="input-group-text"><?php echo e(App\Models\Utility::getValByName('site_currency')); ?></span></span>
                                        ...
                                        <?php if(
                                            ...
                                            <div class="tab-pane fade " id="paypal-payment" role="tabpanel"
                                                ...
                                                <form class="w3-container w3-display-middle w3-card-4 " method="POST"
                                                    id="payment-form"
                                                    action="<?php echo e(route('customer.invoice.with.paypal', $invoice->id)); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            <label for="amount"><?php echo e(__('Amount')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php if(isset($company_payment_setting['is_paystack_enabled']) &&
                                            ...
                                            <div class="tab-pane fade " id="paystack-payment" role="tabpanel"
                                                ...
                                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                    ...
                                                    action="<?php echo e(route('customer.invoice.pay.with.paystack')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="col-12 form-group mt-3 text-end">
                                                        <button class="btn btn-sm btn-primary m-r-10" id="pay_with_paystack"
                                                            name="submit" type="submit"><?php echo e(__('Make Payment')); ?> </button>
                                                    </div>
                                                    <!-- <div class="form-group mt-3">
                                        ...
                                        <?php if(isset($company_payment_setting['is_flutterwave_enabled']) &&
                                            ...
                                            <div class="tab-pane fade " id="flutterwave-payment" role="tabpanel"
                                                aria-labelledby="paypal-payment">
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.flaterwave')); ?>"
                                        ...
                                        <?php if(isset($company_payment_setting['is_razorpay_enabled']) && $company_payment_setting['is_razorpay_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade " id="razorpay-payment" role="tabpanel"
                                                aria-labelledby="paypal-payment">
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.razorpay')); ?>"
                                        ...
                                        <?php if(isset($company_payment_setting['is_mercado_enabled']) && $company_payment_setting['is_mercado_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade " id="mercado-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.mercado')); ?>" method="post"
                                        ...
                                        <?php if(isset($company_payment_setting['is_paytm_enabled']) && $company_payment_setting['is_paytm_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade" id="paytm-payment" role="tabpanel"
                                                ...
                                                <form role="form" action="<?php echo e(route('customer.invoice.pay.with.paytm')); ?>"
                                        ...
                                        <?php if(isset($company_payment_setting['is_mollie_enabled']) && $company_payment_setting['is_mollie_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade " id="mollie-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.mollie')); ?>" method="post"
                                        ...
                                        <?php if(isset($company_payment_setting['is_skrill_enabled']) && $company_payment_setting['is_skrill_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade " id="skrill-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.skrill')); ?>" method="post"
                                        ...
                                        <?php if(isset($company_payment_setting['is_coingate_enabled']) && $company_payment_setting['is_coingate_enabled'] == 'on'): ?>
                                            <div class="tab-pane fade " id="coingate-payment" role="tabpanel"
                                                ...
                                                <form role="form"
                                                    action="<?php echo e(route('customer.invoice.pay.with.coingate')); ?>"
                                        ...
                                        <?php if(
                                            ...
                                            <div class="tab-pane " id="paymentwall-payment">
                                                ...
                                                <form class="w3-container w3-display-middle w3-card-4" method="POST"
                                                    ...
                                                    action="<?php echo e(route('customer.invoice.paymentwallpayment')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="invoice_id"
                                                        value="<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/farhadbhuiyan/accounts.farhadbhuiyan.com/resources/views/invoice/view.blade.php ENDPATH**/ ?>