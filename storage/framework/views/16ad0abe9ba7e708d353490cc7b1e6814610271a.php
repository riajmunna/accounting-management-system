                    ...
                    <tr>
                        ...
                        <td>
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td class="text-right" style="padding-left: 346px;"><?php echo e(__('Number')); ?>:</td>
                                        <td class="text-right">
                                            <?php echo e(Utility::billNumberFormat($settings, $bill->bill_id)); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-right" style="padding-left: 346px;"><?php echo e(__('Issue Date')); ?>:
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-right" style="padding-left: 346px;"><?php echo e(__('Due Date')); ?>:</td>
                                        <td class="text-right"><?php echo e(Utility::dateFormat($settings, $bill->issue_date)); ?>
...
<?php /**PATH /home/farhadbhuiyan/accounts.farhadbhuiyan.com/resources/views/bill/templates/template3.blade.php ENDPATH**/ ?>